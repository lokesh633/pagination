    ...
    <div className="page-container">
      ...
      <ul class="pagination" style={style}>
        <li className={`page-item ${CurrentPage=== 1  ? "disabled":""}`} >
          <span class="page-link" onClick={handlePrevious}>Previous</span>
        </li>
        ...
        <li class="page-item"  className={`page-item ${CurrentPage === pageCount  ? "disabled":""}`}>
          <span class="page-link" onClick={handleNext}>Next</span>
        </li>
      </ul>
      </div>
    </div>
